...
const data = [
  {
    bestPerformingTextt: "Best perrforming student 2024",
    image: "images/img_star_1.svg",
    imageone: "images/img_ellipse_292.png",
    userName: "Awoyemi Victor ",
...
export default function AcademicProgramAchievements() {
  // Step 1: Create state to track the active button
  const [activeMenu, setActiveMenu] = useState("Certificates and Achievements"); // Default active is "Courses"
            ...
            <div className="ml-3.5 mr-[34px] flex flex-col items-start gap-6 md:mx-0">
              ...
              <div className="flex items-start gap-3.5 self-stretch md:flex-col">
                  ...
                  <div className="flex flex-col items-start gap-3 rounded-[10px] border border-solid border-grey_100 bg-foundation-primary_color-p50-1 p-3.5">
                    ...
                    <div className="mb-[158px] flex flex-col gap-2 self-stretch">
                      ...
                      <button
                        ...
                        onClick={() => handleMenuClick("Lectures and Lessons")}
                      >
                        <Link
                ...
                <div className="flex-1 self-center md:self-stretch md:p-5">
                  <div className="flex flex-col items-start gap-[26px] rounded-[10px] border border-solid border-grey_100 bg-foundation-primary_color-p50-1 px-[22px] py-6 sm:px-5">
                    ...
                    <div className="grid grid-cols-2 gap-4 self-stretch md:grid-cols-1">
                      <Suspense fallback={<div>Loading feed...</div>}>
                        {data.map((d, index) => (
                          <Link
                            to={`/achievements/${index}`}
                            key={"gridbestperform" + index}
                            // className="flex"
                          >
                            <UserProfile4 {...d} />
                          </Link>
