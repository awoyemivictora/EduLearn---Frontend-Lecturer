...
const data = [
  {
    ...
    view: "View",
    viewtwo: "images/img_chevronleft.svg",
    image: "images/img_ellipse_1_34x34.png",
    userTitle: "Professor",
...
export default function AcademicProgramAssignments() {
  // Step 1: Create state to track the active button
  const [activeMenu, setActiveMenu] = useState("Assignments"); // Default active is "Courses"
