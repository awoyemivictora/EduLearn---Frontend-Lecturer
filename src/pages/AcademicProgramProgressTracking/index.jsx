...
const data = [
  {
    ...
    courseTiitle: "Programming language",
    courseDescription:
  ...
  },
  {
    ...
    courseTiitle: "Finance and banking",
    courseDescription:
      "Learn the fundamentals of coding and problem-solving using popular programming languages.",
    inProgressText: "In Progress",
    resumeCourseText: "Resume Course",
  },
  {
    ...
    courseTiitle: "Financial modelling and value",
    courseDescription:
      "Learn the fundamentals of coding and problem-solving using popular programming languages.",
    inProgressText: "Completed",
    resumeCourseText: "Resume Course",
  },
  {
    circleprogress: "42",
...
export default function AcademicProgramProgressTracking() {
  // Step 1: Create state to track the active button
  const [activeMenu, setActiveMenu] = useState("Progress Tracking"); // Default active is "Courses"
                      ...
                      <div className="grid grid-cols-2 gap-4 self-stretch md:grid-cols-1">
                        <Suspense fallback={<div>Loading feed...</div>}>
                          {data.map((d, index) => (
                            <Link
                              to={`/courses/${index}`}
                              key={"gridtwentyfour" + index}
                              className="flex"
                            >
                              <UserProgressOverview {...d} />
                            </Link>
                          ))}
                        </Suspense>
                      </div>
