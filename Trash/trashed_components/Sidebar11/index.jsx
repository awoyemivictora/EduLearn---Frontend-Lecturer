...
export default function Sidebar11({ ...props }) {
    return (
        <Sidebar
            ...
            className={`${props.className} flex flex-col h-screen mt-4 top-0 !sticky overflow-auto `}
        >
            <div className="self-stretch rounded-lg border border-solid border-grey_100 bg-foundation-primary_color-p50-1 px-2 py-3.5">
            ...
            <Menu
                ...
                className="mt-4 flex w-full flex-col self-stretch pl-4"
            >
                ...
                <SubMenu icon={ <Img src="images/img_calendar_days_foundation__primary_color_p300.svg" alt="Calendardays" className="h-[12px] w-[12px]" />} 
                ...
                <MenuItem icon={ <Img src="images/img_library_big.svg" alt="Librarybig" className="h-[12px] w-[12px]" />} >
                    Resources
                </MenuItem>
            </Menu>
