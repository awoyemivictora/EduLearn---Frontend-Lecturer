...
export default function Sidebar12({ ...props }) {
    return (
        ...
        >
            <div className="self-stretch rounded-lg border border-solid border-grey_100">
            ...
            >
                ...
                <SubMenu 
                    icon={<Img src="images/img_radio_foundation__primary_color_p300.svg" alt="Radio" className="h-[12px] w-[12px]" />}
                    label="Live Events"
                >
